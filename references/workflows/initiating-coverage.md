...
Produces institutional-grade first-time coverage reports (JPMorgan / Goldman Sachs / Morgan Stanley format) through 5 sequential tasks.
...
2. Load detailed instructions from ../initiating-coverage/task1-company-research.md
...
2. Load detailed instructions from ../initiating-coverage/task2-financial-modeling.md
...
2. Load detailed instructions from ../initiating-coverage/task3-valuation.md
...
2. Load detailed instructions from ../initiating-coverage/task4-chart-generation.md
...
2. Load detailed instructions from ../initiating-coverage/task5-report-assembly.md
...
- **../initiating-coverage/task1-company-research.md** - Company research workflow
- **../initiating-coverage/task2-financial-modeling.md** - Financial modeling workflow
- **../initiating-coverage/task3-valuation.md** - Valuation methodology
  - Also see: ../initiating-coverage/valuation-methodologies.md for DCF/comps deep dive
